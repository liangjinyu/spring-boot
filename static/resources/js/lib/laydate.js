...
function(a) {
    ...
    c.viewYears = function(a) {
        ...
        c.each(new Array(14),
        function(b) {
            d += 7 === b ? "<li " + (parseInt(h.year.value) === a ? 'class="' + h[2] + '"': "class=laydate_luo_cs") + ' y="' + a + '">' + a + "年</li>": '<li class=laydate_luo_cs y="' + (a - 7 + b) + '">' + (a - 7 + b) + "年</li>"
        }),
    ...
    c.view = function(a, f) {
        ...
        c.box ? c.shde(c.box) : (i = d[e]("div"), i.id = h[0], i.className = h[0], i.style.cssText = "position: absolute;", i.setAttribute("name", "laydate-v" + laydate.v), i.innerHTML = j.html = '<div class="laydate_top"><div class="laydate_ym laydate_y" id="laydate_YY"><a class="laydate_choose laydate_chprev laydate_tab"><cite class="laydate_luo_cs"></cite></a><input id="laydate_y" class="laydate_luo_cs" readonly><label class="laydate_luo_cs"></label><a class="laydate_choose laydate_chnext laydate_tab"><cite class="laydate_luo_cs"></cite></a><div class="laydate_yms"><a class="laydate_tab laydate_chtop"><cite class="laydate_luo_cs"></cite></a><ul id="laydate_ys" class="laydate_luo_cs"></ul><a class="laydate_tab laydate_chdown"><cite class="laydate_luo_cs"></cite></a></div></div><div class="laydate_ym laydate_m" id="laydate_MM"><a class="laydate_choose laydate_chprev laydate_tab"><cite></cite></a><input id="laydate_m" readonly><label class="laydate_luo_cs"></label><a class="laydate_choose laydate_chnext laydate_tab"><cite class="laydate_luo_cs"></cite></a><div class="laydate_yms" id="laydate_ms">' +
        function() {
            var a = "";
    ...
    c.events = function() {
        ...
        function() {
            ...
            c.options.choose(), //修改源码，让选择“今天”按钮触发配置项里面的choose选项
            c.close()
        }),
        h.ok = b("#laydate_ok"),
        c.on(h.ok, "click",
